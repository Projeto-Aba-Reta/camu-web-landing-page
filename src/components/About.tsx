...
export default function About() {
  return (
    <section
      id="sobre"
      className="bg-offwhite-2 px-6 py-16 sm:px-10 md:py-20 lg:flex lg:min-h-[80vh] lg:items-center"
    >
      <div className="mx-auto grid w-full max-w-6xl items-center gap-10 md:grid-cols-[0.9fr_1.1fr]">
        ...
        <div className="text-center md:text-left">
          ...
          <p className="mx-auto mt-4 max-w-xl text-base leading-relaxed text-charcoal/75 sm:text-lg md:mx-0">
            ...
            geek — se você imaginou, a gente imprime, camada por camada. Leon é
            o símbolo disso: um bicho que se adapta e se transforma no que for
